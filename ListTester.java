...
public class ListTester {
	...
	private void runTests() {
		...
		if (SUPPORTS_LIST_ITERATOR) {
			// Scenario: 57
			testSingleElementList(AB_listIterNextRemove_A, "AB_listIterNextRemove_A", LIST_A, STRING_A);
			// Scenario: 60
			testTwoElementList(ABC_listIterNextRemove_AC, "ABC_listIterNextRemove_AC", LIST_AC, STRING_AC);
			// Scenario: 66
			testEmptyList(A_listIterPreviousRemove_emptyList, "A_listIterPreviousRemove_emptyList");
			// Scenario: 71
			testTwoElementList(ABC_listIterPreviousRemove_AC, "ABC_listIterPreviousRemove_AC", LIST_AC, STRING_AC);
			// Scenario: 87
			testThreeElementList(AB_listIterNextAddC_ACB, "AB_listIterNextAddC_ACB", LIST_ACB, STRING_ACB);
			// Scenario: 90
			testThreeElementList(AB_listIterPreviousAddC_ACB, "AB_listIterPreviousAddC_ACB", LIST_ACB, STRING_ACB);
			// Scenario: 96
			testThreeElementList(ABC_listIterNextSetD_ADC, "ABC_listIterNextSetD_ADC", LIST_ADC, STRING_ADC);
			// Scenario: 99
			testThreeElementList(ABC_listIterPreviousSetD_ADC, "ABC_listIterPreviousSetD_ADC", LIST_ADC, STRING_ADC);
		}
	...
	/**
	 * Scenario #57: [A,B] -> listIterator, next(), remove() -> [A]
	 * 
	 * @return [A] after listIterator, next(), remove()
	 */
	private IndexedUnsortedList<Integer> AB_listIterNextRemove_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
	...
	private Scenario<Integer> AB_listIterNextRemove_A = () -> AB_listIterNextRemove_A();

	/**
	 * Scenario #60: [A,B,C] -> listIterator, next(), remove() -> [A,C]
	 * 
	 * @return [A,C] after listIterator, next(), remove()
	 */
	private IndexedUnsortedList<Integer> ABC_listIterNextRemove_AC() {
		IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.remove();
	...
	private Scenario<Integer> ABC_listIterNextRemove_AC = () -> ABC_listIterNextRemove_AC();

	/**
	 * Scenario #66: [A] -> listIterator, previous(), remove() -> []
	 * 
	 * @return [] after listIterator, previous(), remove()
	 */
	private IndexedUnsortedList<Integer> A_listIterPreviousRemove_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> A_listIterPreviousRemove_emptyList = () -> A_listIterPreviousRemove_emptyList();

	/**
	 * Scenario #71: [A,B,C] -> listIterator, previous(), remove() -> [B,C]
	 * 
	 * @return [B,C] after listIterator, previous(), remove()
	 */
	private IndexedUnsortedList<Integer> ABC_listIterPreviousRemove_AC() {
		IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
	...
	private Scenario<Integer> ABC_listIterPreviousRemove_AC = () -> ABC_listIterPreviousRemove_AC();

	/**
	 * Scenario #87: [A,B] -> listIterator, next(), add(C) -> [A,C,B]
	 * 
	 * @return [A,C,B] after listIterator, next(), add(C)
	 */
	...
	/**
	 * Scenario #90: [A,B] -> listIterator, previous(), add(C) -> [A,C,B]
	 * 
	 * @return [A,C,B] after listIterator, previous(), add(C)
	 */
	...
	/**
	 * Scenario #96: [A,B,C] -> listIterator, next(), set(D) -> [A,D,C]
	 * 
	 * @return [A,D,C] after listIterator, next(), set(D)
	 */
	...
	/**
	 * Scenario #99: [A,B,C] -> listIterator, previous(), set(D) -> [A,D,B]
	 * 
	 * @return [A,D,B] after listIterator, previous(), set(D)
	 */
